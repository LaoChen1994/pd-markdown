# PD-Markdown Next JS SSG Demo

This workspace demonstrates how to use `pd-markdown` in a pure statically-generated environment using **Next.js App Router API**.
